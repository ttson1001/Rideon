...
import { ArrowRight, DollarSign, Shield, Clock, Users, CheckCircle, Star } from 'lucide-react';
  ...
  const testimonials = [
    {
      ...
      quote: "Từ khi tham gia MotoBike, tôi có thêm nguồn thu nhập ổn định mà không tốn nhiều thời gian quản lý.",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Nền tảng rất dễ sử dụng, khách hàng đáng tin cậy. Tôi rất hài lòng với dịch vụ.",
      rating: 5,
      avatar: "/placeholder.svg?height=60&width=60",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-yellow-400 text-black hover:bg-yellow-500">Cơ hội kiếm tiền</Badge>
                <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                  Trở thành
                  <span className="block text-yellow-400">chủ xe MotoBike</span>
                </h1>
                <p className="text-xl text-white max-w-lg">
                  Biến xe máy của bạn thành nguồn thu nhập thụ động. Tham gia cộng đồng hơn 5,000 chủ xe đang kiếm tiền
                  mỗi ngày.
                </p>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Tại sao nên trở thành chủ xe MotoBike?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Khám phá những lợi ích tuyệt vời khi tham gia cộng đồng chủ xe của chúng tôi
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Điều kiện tham gia</h2>
            <p className="text-gray-600">Đảm bảo bạn đáp ứng các yêu cầu sau để trở thành chủ xe</p>
          </div>

          <Card className="p-8">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Yêu cầu cần thiết:</h3>
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h4 className="font-semibold text-blue-900 mb-3">💡 Mẹo để tăng thu nhập:</h4>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Nghe chia sẻ từ những chủ xe đang kiếm tiền cùng MotoBike</p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="ml-auto text-right">
                      <div className="text-lg font-bold text-green-600">{testimonial.income}</div>
                      <div className="text-xs text-gray-500">Thu nhập/tháng</div>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 text-sm text-blue-200">Miễn phí đăng ký • Không phí ẩn • Hỗ trợ 24/7</div>
        </div>
      </section>
    </div>
  );
